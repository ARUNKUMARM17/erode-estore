              ...
              {isPrimeMember && product.primeDiscount?.isEligible ? (
                <div className="price-container my-4">
                  ...
                  <div className="savings">
                    You save: ${product.primeDiscount.savings.toFixed(2)} with Prime
                  </div>
                </div>
              ) : (
                <p className="text-5xl my-4 font-extrabold">
                  ...
                  {product.primeDiscount?.isEligible && (
                    <div className="prime-eligible mt-2">
                      <FaCrown />
                      <span>Eligible for Prime discount</span>
                    </div>
                  )}
                </p>
              )}
